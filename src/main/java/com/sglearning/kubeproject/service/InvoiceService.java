...
public class InvoiceService {
    ...
    private final Map<String, Map<String, Object>> invoices = new HashMap<>();

    public Map<String, Object> processInvoice(String invoiceId, String customerName, double amount) {
        ...
        invoices.put(invoiceId, result);
        return result;
    }

    public List<Map<String, Object>> getInvoiceReport() {
        List<Map<String, Object>> report = new ArrayList<>();
        for (Map.Entry<String, Map<String, Object>> entry : invoices.entrySet()) {
            Map<String, Object> reportItem = new HashMap<>();
            reportItem.put("invoiceId", entry.getKey());
    ...
    public Map<String, Object> validateInvoice(String invoiceId, String customerName, double amount) {
        Map<String, Object> validationResult = new HashMap<>();
        validationResult.put("invoiceId", invoiceId);
        ...
        if (invoiceId == null || invoiceId.isEmpty()) {
            ...
            validationResult.put("error", "Invoice ID is required");
